...
enum
{
  gazebo_msgs__srv__ApplyLinkWrench_Event__request__MAX_SIZE = 1
};
// response
enum
{
  gazebo_msgs__srv__ApplyLinkWrench_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/ApplyLinkWrench in the package gazebo_msgs.
typedef struct gazebo_msgs__srv__ApplyLinkWrench_Event
{
  service_msgs__msg__ServiceEventInfo info;
  gazebo_msgs__srv__ApplyLinkWrench_Request__Sequence request;
  gazebo_msgs__srv__ApplyLinkWrench_Response__Sequence response;
} gazebo_msgs__srv__ApplyLinkWrench_Event;

// Struct for a sequence of gazebo_msgs__srv__ApplyLinkWrench_Event.
typedef struct gazebo_msgs__srv__ApplyLinkWrench_Event__Sequence
{
