  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const gazebo_msgs__msg__LinkState * ros_message = static_cast<const gazebo_msgs__msg__LinkState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_gazebo_msgs__msg__LinkState(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  gazebo_msgs__msg__LinkState * ros_message = static_cast<gazebo_msgs__msg__LinkState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_gazebo_msgs__msg__LinkState(cdr, ros_message);
}
