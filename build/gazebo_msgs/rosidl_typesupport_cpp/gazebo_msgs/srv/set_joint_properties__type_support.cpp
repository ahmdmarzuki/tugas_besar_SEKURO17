...
static const _SetJointProperties_Event_type_support_symbol_names_t _SetJointProperties_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gazebo_msgs, srv, SetJointProperties_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gazebo_msgs, srv, SetJointProperties_Event)),
  }
};
...
{
  return &::gazebo_msgs::srv::rosidl_typesupport_cpp::SetJointProperties_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, gazebo_msgs, srv, SetJointProperties_Event)() {
  return get_message_type_support_handle<gazebo_msgs::srv::SetJointProperties_Event>();
}
...
static const rosidl_service_type_support_t SetJointProperties_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<gazebo_msgs::srv::SetJointProperties_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<gazebo_msgs::srv::SetJointProperties_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<gazebo_msgs::srv::SetJointProperties_Event>(),
