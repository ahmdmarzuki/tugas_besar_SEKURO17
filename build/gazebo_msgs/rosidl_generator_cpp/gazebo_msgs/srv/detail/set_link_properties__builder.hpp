...
class Init_SetLinkProperties_Event_response
{
public:
  explicit Init_SetLinkProperties_Event_response(::gazebo_msgs::srv::SetLinkProperties_Event & msg)
  : msg_(msg)
  {}
  ::gazebo_msgs::srv::SetLinkProperties_Event response(::gazebo_msgs::srv::SetLinkProperties_Event::_response_type arg)
  {
...
private:
  ::gazebo_msgs::srv::SetLinkProperties_Event msg_;
};

class Init_SetLinkProperties_Event_request
{
public:
  explicit Init_SetLinkProperties_Event_request(::gazebo_msgs::srv::SetLinkProperties_Event & msg)
  : msg_(msg)
  {}
  Init_SetLinkProperties_Event_response request(::gazebo_msgs::srv::SetLinkProperties_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_SetLinkProperties_Event_response(msg_);
  }
...
class Init_SetLinkProperties_Event_info
{
public:
  Init_SetLinkProperties_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SetLinkProperties_Event_request info(::gazebo_msgs::srv::SetLinkProperties_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_SetLinkProperties_Event_request(msg_);
  }
...
template<>
inline
auto build<::gazebo_msgs::srv::SetLinkProperties_Event>()
{
  return gazebo_msgs::srv::builder::Init_SetLinkProperties_Event_info();
}
