...
class Init_ApplyLinkWrench_Event_response
{
public:
  explicit Init_ApplyLinkWrench_Event_response(::gazebo_msgs::srv::ApplyLinkWrench_Event & msg)
  : msg_(msg)
  {}
  ::gazebo_msgs::srv::ApplyLinkWrench_Event response(::gazebo_msgs::srv::ApplyLinkWrench_Event::_response_type arg)
  {
...
private:
  ::gazebo_msgs::srv::ApplyLinkWrench_Event msg_;
};

class Init_ApplyLinkWrench_Event_request
{
public:
  explicit Init_ApplyLinkWrench_Event_request(::gazebo_msgs::srv::ApplyLinkWrench_Event & msg)
  : msg_(msg)
  {}
  Init_ApplyLinkWrench_Event_response request(::gazebo_msgs::srv::ApplyLinkWrench_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_ApplyLinkWrench_Event_response(msg_);
  }
...
class Init_ApplyLinkWrench_Event_info
{
public:
  Init_ApplyLinkWrench_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_ApplyLinkWrench_Event_request info(::gazebo_msgs::srv::ApplyLinkWrench_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_ApplyLinkWrench_Event_request(msg_);
  }
...
template<>
inline
auto build<::gazebo_msgs::srv::ApplyLinkWrench_Event>()
{
  return gazebo_msgs::srv::builder::Init_ApplyLinkWrench_Event_info();
}
