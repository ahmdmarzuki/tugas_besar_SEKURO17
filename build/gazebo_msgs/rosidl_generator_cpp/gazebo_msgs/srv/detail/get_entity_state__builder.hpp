...
{
public:
  explicit Init_GetEntityState_Event_response(::gazebo_msgs::srv::GetEntityState_Event & msg)
  : msg_(msg)
  {}
  ::gazebo_msgs::srv::GetEntityState_Event response(::gazebo_msgs::srv::GetEntityState_Event::_response_type arg)
  {
...
private:
  ::gazebo_msgs::srv::GetEntityState_Event msg_;
};

class Init_GetEntityState_Event_request
{
public:
  explicit Init_GetEntityState_Event_request(::gazebo_msgs::srv::GetEntityState_Event & msg)
  : msg_(msg)
  {}
  Init_GetEntityState_Event_response request(::gazebo_msgs::srv::GetEntityState_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_GetEntityState_Event_request info(::gazebo_msgs::srv::GetEntityState_Event::_info_type arg)
  {
...
template<>
inline
auto build<::gazebo_msgs::srv::GetEntityState_Event>()
{
  return gazebo_msgs::srv::builder::Init_GetEntityState_Event_info();
}
