...
void gazebo_msgs__srv__GetModelList_Event__rosidl_typesupport_introspection_c__GetModelList_Event_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  gazebo_msgs__srv__GetModelList_Event__init(message_memory);
}

void gazebo_msgs__srv__GetModelList_Event__rosidl_typesupport_introspection_c__GetModelList_Event_fini_function(void * message_memory)
{
  gazebo_msgs__srv__GetModelList_Event__fini(message_memory);
}

size_t gazebo_msgs__srv__GetModelList_Event__rosidl_typesupport_introspection_c__size_function__GetModelList_Event__request(
  const void * untyped_member)
{
  const gazebo_msgs__srv__GetModelList_Request__Sequence * member =
    (const gazebo_msgs__srv__GetModelList_Request__Sequence *)(untyped_member);
  return member->size;
}

const void * gazebo_msgs__srv__GetModelList_Event__rosidl_typesupport_introspection_c__get_const_function__GetModelList_Event__request(
  const void * untyped_member, size_t index)
{
  const gazebo_msgs__srv__GetModelList_Request__Sequence * member =
    (const gazebo_msgs__srv__GetModelList_Request__Sequence *)(untyped_member);
...
void * gazebo_msgs__srv__GetModelList_Event__rosidl_typesupport_introspection_c__get_function__GetModelList_Event__request(
  void * untyped_member, size_t index)
{
  gazebo_msgs__srv__GetModelList_Request__Sequence * member =
    (gazebo_msgs__srv__GetModelList_Request__Sequence *)(untyped_member);
  return &member->data[index];
}

void gazebo_msgs__srv__GetModelList_Event__rosidl_typesupport_introspection_c__fetch_function__GetModelList_Event__request(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const gazebo_msgs__srv__GetModelList_Request * item =
    ((const gazebo_msgs__srv__GetModelList_Request *)
    gazebo_msgs__srv__GetModelList_Event__rosidl_typesupport_introspection_c__get_const_function__GetModelList_Event__request(untyped_member, index));
  gazebo_msgs__srv__GetModelList_Request * value =
    (gazebo_msgs__srv__GetModelList_Request *)(untyped_value);
  *value = *item;
}

void gazebo_msgs__srv__GetModelList_Event__rosidl_typesupport_introspection_c__assign_function__GetModelList_Event__request(
  void * untyped_member, size_t index, const void * untyped_value)
{
  gazebo_msgs__srv__GetModelList_Request * item =
    ((gazebo_msgs__srv__GetModelList_Request *)
    gazebo_msgs__srv__GetModelList_Event__rosidl_typesupport_introspection_c__get_function__GetModelList_Event__request(untyped_member, index));
  const gazebo_msgs__srv__GetModelList_Request * value =
    (const gazebo_msgs__srv__GetModelList_Request *)(untyped_value);
  *item = *value;
}

bool gazebo_msgs__srv__GetModelList_Event__rosidl_typesupport_introspection_c__resize_function__GetModelList_Event__request(
  void * untyped_member, size_t size)
{
  gazebo_msgs__srv__GetModelList_Request__Sequence * member =
    (gazebo_msgs__srv__GetModelList_Request__Sequence *)(untyped_member);
  gazebo_msgs__srv__GetModelList_Request__Sequence__fini(member);
  return gazebo_msgs__srv__GetModelList_Request__Sequence__init(member, size);
}

size_t gazebo_msgs__srv__GetModelList_Event__rosidl_typesupport_introspection_c__size_function__GetModelList_Event__response(
  const void * untyped_member)
{
  const gazebo_msgs__srv__GetModelList_Response__Sequence * member =
    (const gazebo_msgs__srv__GetModelList_Response__Sequence *)(untyped_member);
  return member->size;
}

const void * gazebo_msgs__srv__GetModelList_Event__rosidl_typesupport_introspection_c__get_const_function__GetModelList_Event__response(
  const void * untyped_member, size_t index)
{
  const gazebo_msgs__srv__GetModelList_Response__Sequence * member =
    (const gazebo_msgs__srv__GetModelList_Response__Sequence *)(untyped_member);
...
void * gazebo_msgs__srv__GetModelList_Event__rosidl_typesupport_introspection_c__get_function__GetModelList_Event__response(
  void * untyped_member, size_t index)
{
  gazebo_msgs__srv__GetModelList_Response__Sequence * member =
    (gazebo_msgs__srv__GetModelList_Response__Sequence *)(untyped_member);
  return &member->data[index];
}

void gazebo_msgs__srv__GetModelList_Event__rosidl_typesupport_introspection_c__fetch_function__GetModelList_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const gazebo_msgs__srv__GetModelList_Response * item =
    ((const gazebo_msgs__srv__GetModelList_Response *)
    gazebo_msgs__srv__GetModelList_Event__rosidl_typesupport_introspection_c__get_const_function__GetModelList_Event__response(untyped_member, index));
  gazebo_msgs__srv__GetModelList_Response * value =
    (gazebo_msgs__srv__GetModelList_Response *)(untyped_value);
  *value = *item;
}

void gazebo_msgs__srv__GetModelList_Event__rosidl_typesupport_introspection_c__assign_function__GetModelList_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  gazebo_msgs__srv__GetModelList_Response * item =
    ((gazebo_msgs__srv__GetModelList_Response *)
    gazebo_msgs__srv__GetModelList_Event__rosidl_typesupport_introspection_c__get_function__GetModelList_Event__response(untyped_member, index));
  const gazebo_msgs__srv__GetModelList_Response * value =
    (const gazebo_msgs__srv__GetModelList_Response *)(untyped_value);
  *item = *value;
}

bool gazebo_msgs__srv__GetModelList_Event__rosidl_typesupport_introspection_c__resize_function__GetModelList_Event__response(
  void * untyped_member, size_t size)
{
  gazebo_msgs__srv__GetModelList_Response__Sequence * member =
    (gazebo_msgs__srv__GetModelList_Response__Sequence *)(untyped_member);
  gazebo_msgs__srv__GetModelList_Response__Sequence__fini(member);
  return gazebo_msgs__srv__GetModelList_Response__Sequence__init(member, size);
}

static rosidl_typesupport_introspection_c__MessageMember gazebo_msgs__srv__GetModelList_Event__rosidl_typesupport_introspection_c__GetModelList_Event_message_member_array[3] = {
  {
    "info",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(gazebo_msgs__srv__GetModelList_Event, info),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(gazebo_msgs__srv__GetModelList_Event, request),  // bytes offset in struct
    NULL,  // default value
    gazebo_msgs__srv__GetModelList_Event__rosidl_typesupport_introspection_c__size_function__GetModelList_Event__request,  // size() function pointer
    gazebo_msgs__srv__GetModelList_Event__rosidl_typesupport_introspection_c__get_const_function__GetModelList_Event__request,  // get_const(index) function pointer
    gazebo_msgs__srv__GetModelList_Event__rosidl_typesupport_introspection_c__get_function__GetModelList_Event__request,  // get(index) function pointer
    gazebo_msgs__srv__GetModelList_Event__rosidl_typesupport_introspection_c__fetch_function__GetModelList_Event__request,  // fetch(index, &value) function pointer
    gazebo_msgs__srv__GetModelList_Event__rosidl_typesupport_introspection_c__assign_function__GetModelList_Event__request,  // assign(index, value) function pointer
    gazebo_msgs__srv__GetModelList_Event__rosidl_typesupport_introspection_c__resize_function__GetModelList_Event__request  // resize(index) function pointer
  },
  {
    "response",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(gazebo_msgs__srv__GetModelList_Event, response),  // bytes offset in struct
    NULL,  // default value
    gazebo_msgs__srv__GetModelList_Event__rosidl_typesupport_introspection_c__size_function__GetModelList_Event__response,  // size() function pointer
    gazebo_msgs__srv__GetModelList_Event__rosidl_typesupport_introspection_c__get_const_function__GetModelList_Event__response,  // get_const(index) function pointer
    gazebo_msgs__srv__GetModelList_Event__rosidl_typesupport_introspection_c__get_function__GetModelList_Event__response,  // get(index) function pointer
    gazebo_msgs__srv__GetModelList_Event__rosidl_typesupport_introspection_c__fetch_function__GetModelList_Event__response,  // fetch(index, &value) function pointer
    gazebo_msgs__srv__GetModelList_Event__rosidl_typesupport_introspection_c__assign_function__GetModelList_Event__response,  // assign(index, value) function pointer
    gazebo_msgs__srv__GetModelList_Event__rosidl_typesupport_introspection_c__resize_function__GetModelList_Event__response  // resize(index) function pointer
  }
};

static const rosidl_typesupport_introspection_c__MessageMembers gazebo_msgs__srv__GetModelList_Event__rosidl_typesupport_introspection_c__GetModelList_Event_message_members = {
  "gazebo_msgs__srv",  // message namespace
  "GetModelList_Event",  // message name
  3,  // number of fields
  sizeof(gazebo_msgs__srv__GetModelList_Event),
  false,  // has_any_key_member_
  gazebo_msgs__srv__GetModelList_Event__rosidl_typesupport_introspection_c__GetModelList_Event_message_member_array,  // message members
  gazebo_msgs__srv__GetModelList_Event__rosidl_typesupport_introspection_c__GetModelList_Event_init_function,  // function to initialize message memory (memory has to be allocated)
  gazebo_msgs__srv__GetModelList_Event__rosidl_typesupport_introspection_c__GetModelList_Event_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t gazebo_msgs__srv__GetModelList_Event__rosidl_typesupport_introspection_c__GetModelList_Event_message_type_support_handle = {
  0,
  &gazebo_msgs__srv__GetModelList_Event__rosidl_typesupport_introspection_c__GetModelList_Event_message_members,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_gazebo_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gazebo_msgs, srv, GetModelList_Event)() {
  gazebo_msgs__srv__GetModelList_Event__rosidl_typesupport_introspection_c__GetModelList_Event_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, service_msgs, msg, ServiceEventInfo)();
  gazebo_msgs__srv__GetModelList_Event__rosidl_typesupport_introspection_c__GetModelList_Event_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gazebo_msgs, srv, GetModelList_Request)();
  gazebo_msgs__srv__GetModelList_Event__rosidl_typesupport_introspection_c__GetModelList_Event_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gazebo_msgs, srv, GetModelList_Response)();
  if (!gazebo_msgs__srv__GetModelList_Event__rosidl_typesupport_introspection_c__GetModelList_Event_message_type_support_handle.typesupport_identifier) {
    gazebo_msgs__srv__GetModelList_Event__rosidl_typesupport_introspection_c__GetModelList_Event_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &gazebo_msgs__srv__GetModelList_Event__rosidl_typesupport_introspection_c__GetModelList_Event_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
static rosidl_service_type_support_t gazebo_msgs__srv__detail__get_model_list__rosidl_typesupport_introspection_c__GetModelList_service_type_support_handle = {
  ...
  &gazebo_msgs__srv__GetModelList_Request__rosidl_typesupport_introspection_c__GetModelList_Request_message_type_support_handle,
  &gazebo_msgs__srv__GetModelList_Response__rosidl_typesupport_introspection_c__GetModelList_Response_message_type_support_handle,
  &gazebo_msgs__srv__GetModelList_Event__rosidl_typesupport_introspection_c__GetModelList_Event_message_type_support_handle,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gazebo_msgs, srv, GetModelList_Request)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gazebo_msgs, srv, GetModelList_Response)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gazebo_msgs, srv, GetModelList_Event)(void);

ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_gazebo_msgs
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gazebo_msgs, srv, GetModelList)(void) {
  ...
  if (!service_members->event_members_) {
    service_members->event_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gazebo_msgs, srv, GetModelList_Event)()->data;
  }
