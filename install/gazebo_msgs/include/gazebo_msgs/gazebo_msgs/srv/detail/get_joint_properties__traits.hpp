...
inline void to_flow_style_yaml(
  const GetJointProperties_Event & msg,
  std::ostream & out)
{
  out << "{";
  // member: info
...
inline std::string to_yaml(const GetJointProperties_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use gazebo_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const gazebo_msgs::srv::GetJointProperties_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  gazebo_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use gazebo_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const gazebo_msgs::srv::GetJointProperties_Event & msg)
{
  return gazebo_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<gazebo_msgs::srv::GetJointProperties_Event>()
{
  return "gazebo_msgs::srv::GetJointProperties_Event";
}

template<>
inline const char * name<gazebo_msgs::srv::GetJointProperties_Event>()
{
  return "gazebo_msgs/srv/GetJointProperties_Event";
}

template<>
struct has_fixed_size<gazebo_msgs::srv::GetJointProperties_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<gazebo_msgs::srv::GetJointProperties_Event>
  : std::integral_constant<bool, has_bounded_size<gazebo_msgs::srv::GetJointProperties_Request>::value && has_bounded_size<gazebo_msgs::srv::GetJointProperties_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<gazebo_msgs::srv::GetJointProperties_Event>
  : std::true_type {};
