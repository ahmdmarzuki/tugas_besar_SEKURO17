...
// IWYU pragma: private, include "gazebo_msgs/srv/set_physics_properties.h"
...
enum
{
  gazebo_msgs__srv__SetPhysicsProperties_Event__request__MAX_SIZE = 1
};
// response
enum
{
  gazebo_msgs__srv__SetPhysicsProperties_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/SetPhysicsProperties in the package gazebo_msgs.
typedef struct gazebo_msgs__srv__SetPhysicsProperties_Event
{
  service_msgs__msg__ServiceEventInfo info;
  gazebo_msgs__srv__SetPhysicsProperties_Request__Sequence request;
  gazebo_msgs__srv__SetPhysicsProperties_Response__Sequence response;
} gazebo_msgs__srv__SetPhysicsProperties_Event;

// Struct for a sequence of gazebo_msgs__srv__SetPhysicsProperties_Event.
typedef struct gazebo_msgs__srv__SetPhysicsProperties_Event__Sequence
{
