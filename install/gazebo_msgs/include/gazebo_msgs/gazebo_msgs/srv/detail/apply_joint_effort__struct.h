...
// IWYU pragma: private, include "gazebo_msgs/srv/apply_joint_effort.h"
...
enum
{
  gazebo_msgs__srv__ApplyJointEffort_Event__request__MAX_SIZE = 1
};
// response
enum
{
  gazebo_msgs__srv__ApplyJointEffort_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/ApplyJointEffort in the package gazebo_msgs.
typedef struct gazebo_msgs__srv__ApplyJointEffort_Event
{
  service_msgs__msg__ServiceEventInfo info;
  gazebo_msgs__srv__ApplyJointEffort_Request__Sequence request;
  gazebo_msgs__srv__ApplyJointEffort_Response__Sequence response;
} gazebo_msgs__srv__ApplyJointEffort_Event;

// Struct for a sequence of gazebo_msgs__srv__ApplyJointEffort_Event.
typedef struct gazebo_msgs__srv__ApplyJointEffort_Event__Sequence
{
