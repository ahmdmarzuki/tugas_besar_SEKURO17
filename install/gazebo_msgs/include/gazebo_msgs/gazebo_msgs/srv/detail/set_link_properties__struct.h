...
enum
{
  gazebo_msgs__srv__SetLinkProperties_Event__request__MAX_SIZE = 1
};
// response
enum
{
  gazebo_msgs__srv__SetLinkProperties_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/SetLinkProperties in the package gazebo_msgs.
typedef struct gazebo_msgs__srv__SetLinkProperties_Event
{
  service_msgs__msg__ServiceEventInfo info;
  gazebo_msgs__srv__SetLinkProperties_Request__Sequence request;
  gazebo_msgs__srv__SetLinkProperties_Response__Sequence response;
} gazebo_msgs__srv__SetLinkProperties_Event;

// Struct for a sequence of gazebo_msgs__srv__SetLinkProperties_Event.
typedef struct gazebo_msgs__srv__SetLinkProperties_Event__Sequence
{
